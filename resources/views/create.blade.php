                ...
                <div class="card-body">
                    <form action="{{ route('emp.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 form-control">
                            ...
                            <input type="numbeer" id="phonenumber" name="phonenumber" value="{{ old('phonenumber') }}">
                            @error('phonenumber')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3 form-control">
                            ...
                            <input type="date" id="dateofjoin" name="dateofjoin" value="{{ old('dateofjoin') }}">
                            @error('dateofjoin')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3 form-control">
                            ...
                            <select name="department" id="department">
                                ...
                                @foreach ($departments as $department)
                                    <option value="{{ $department }}" @selected(old('department') == $department)>{{ $department }}
                                    </option>
                                @endforeach
                            </select>
                            @error('department')
                        ...
                        <div class="mb-3 form-control">
                            ...
                            @foreach ($skills as $skill)
                                <input type="checkbox" name="skills[]" value="{{ $skill }}" id="skills"
                                    @checked(in_array($skill, old('skills', [])))>{{ $skill }}
                            @endforeach
                            @error('skills')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div>
                            ...
                            <select name="country" id="country">
                                ...
                                @foreach ($countries as $id => $name)
                                    <option value="{{ $id }}" @selected(old('country') == $id)>{{ $name }}
                                    </option>
                                @endforeach
                            </select>
                            @error('country')
